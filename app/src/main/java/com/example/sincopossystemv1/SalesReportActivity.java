    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesReportActivity.this, HomeActivity.class));
            }
        });
        ...
        ProductsLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesReportActivity.this, ProductsActivity.class));
            }
        });
        ...
        SalesReportLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesReportActivity.this, SalesReportActivity.class));
            }
        });
        ...
        InventoryLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesReportActivity.this, InventoryActivity.class));
            }
        });
        ...
        SettingsLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesReportActivity.this, SettingsActivity.class));
            }
        });
        ...
        LogoutLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesReportActivity.this, LogoutActivity.class));
